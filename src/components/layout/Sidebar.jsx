...
//     href: '/src/components/terms/TermsSection.jsx',
//     icon: Shield,
//   },
// ]
...
const Sidebar = () => {
  return (
    <div className='hidden lg:fixed lg:top-[12vh] lg:bottom-0 lg:z-20 lg:flex lg:w-72 lg:flex-col bg-secondary m-2 rounded-2xl flex flex-col h-full p-3 w-60 dark:bg-secondary dark:text-gray-50'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <button className='p-2'>
            <svg
              ...
              viewBox='0 0 512 512'
              className='w-5 h-5 fill-current dark:text-gray-50'
            >
