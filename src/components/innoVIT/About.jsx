  ...
  return (
    <section className="py-20 bg-primary">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold text-textColor mb-6">About Our College</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            {stats.map((stat, index) => (
              <div key={index} className="p-4 bg-secondary rounded-lg">
                <div className="text-3xl font-bold text-textColor mb-2">{stat.value}</div>
          ...
          <div className="bg-secondary p-8 rounded-lg">
            <h3 className="text-2xl font-bold text-textColor mb-4">Our Mission</h3>
            ...
            <h3 className="text-2xl font-bold text-textColor mb-4">Campus Highlights</h3>
