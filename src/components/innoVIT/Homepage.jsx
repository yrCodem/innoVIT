...
import LiquidEther from './LiquidEther' // Adjust the import path based on your project structure
...
const Homepage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      {/* Liquid Ether Background - Full screen behind everything */}
              ...
              <Link to={'/login'}>
                <div>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className='font-sora text-xl bg-textColor w-fit text-primary font-black p-4 pl-8 pr-8 rounded-full hover:bg-white transition-colors'
                  >
                    Sign in
                  </motion.button>
                </div>
