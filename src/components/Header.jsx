...
const Header = () => {
  return (
    <div className="header flex justify-between items-center w-[100vw] h-24 bg-primary font-sora">
      <div className="header-left text-textColor ml-8">
        <h1 className="text-3xl font-black tracking-wider">innoVIT</h1>
      </div>
      <div className="header-right">
        <ul className="list-none flex">
          ...
          >
            ...
            <Link className="ml-1 text-sm" to="/">
              Home
            </Link>
          </li>
          <li
          ...
          >
            ...
            <Link className="ml-1 text-sm" to="/unicollab">
              UniCollab
            </Link>
          </li>
          <li
          ...
          >
            ...
            <Link className="ml-1 text-sm" to="/study">
              Study
            </Link>
          </li>
          <li
            className="group mr-8 p-3 border-[1.5px] rounded-full text-textColor bg-secondary hover:bg-textColor hover:text-primary flex items-center transition" 
            id="header-links"
          >
            <svg
            ...
            <Link className="ml-1 text-sm" to="/login">
              Get Started
            </Link>
          </li>
        </ul>
